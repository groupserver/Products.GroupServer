## Script (Python) "edem_add_announcement_group"
...
##title=E-Democracy.Org Add Announcement Group
##
...
canonical_host = site_root.GlobalConfiguration.getProperty('canonicalHost')
