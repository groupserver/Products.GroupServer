	...
	*/
	...
	function Calendar(thisDate, containerID, imgPath){
	  g_Calendar = this;
	  ...
	  if (browser.dom || browser.ie4){
		var tmpLayer = browser.dom?document.getElementById(this.containerID):document.all.container;
	  }
...
*/
	...
	function handleDocumentClick(e){
	  ...
	  if (browser.ie4 || browser.ie5 && g_Calendar.containerLayer){
	...
	// Handle window click events so we can close the calendar if the user clicks away from it.
